...
const MUSHROOM_GILL_ATTACHMENT_MARKDOWN: &str = include_str!("../mushroom_markdowns/mushroom_first_cat_col_markdown.md");
const MUSHROOM_GILL_ATTACHMENT_IMAGE: Asset = asset!("src/mushroom/mushroom_assets/cap_diameter.png");
