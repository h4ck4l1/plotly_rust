...
const MUSHROOM_CAP_SHAPE_MARKDOWN: &str = include_str!("../mushroom_markdowns/mushroom_first_cat_col_markdown.md");
const MUSHROOM_CAP_SHAPE_IMAGE: Asset = asset!("src/mushroom/mushroom_assets/cap_diameter.png");

#[component]
pub fn MushroomCapShapeColumn() -> Element {
